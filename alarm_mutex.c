...
void *alarm_thread(void *arg)
{
	...
	/*
	 * Unlock the mnutex before waiting, so that the main
...
int main(int argc, char **argv)
{
	...
	if ((alarm = (alarm_t *)malloc(sizeof(alarm_t))) == NULL) {
	    errno_abort("Alloc alarm");
	}

	/*
	 * Please input line into seconds (%d) and a message
	...
	if (sscanf(line, "%d %64[^\n]",
	    ...
	    /*
	     * Insert the new alarm to the list of alarms,
